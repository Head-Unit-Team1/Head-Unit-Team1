...
public:
    ...
    typedef std::function<void(const CommonAPI::CallStatus&, const int32_t&, const std::string&)> GetGearAsyncCallback;
    ...
    virtual void getGear(CommonAPI::CallStatus &_internalCallStatus, int32_t &_result, std::string &_gear, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> getGearAsync(GetGearAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
