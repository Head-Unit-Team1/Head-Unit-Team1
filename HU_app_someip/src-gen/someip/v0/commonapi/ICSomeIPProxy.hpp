...
public:
    ...
    virtual void getGear(CommonAPI::CallStatus &_internalCallStatus, int32_t &_result, std::string &_gear, const CommonAPI::CallInfo *_info);

    virtual std::future<CommonAPI::CallStatus> getGearAsync(GetGearAsyncCallback _callback, const CommonAPI::CallInfo *_info);
