/****************************************************************************
** Meta object code from reading C++ file 'current_clock.h'
**
...
#error "The header file 'current_clock.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(5, 42, 10), // "today_date"
QT_MOC_LITERAL(6, 53, 17) // "currentTime_short"

    },
    "Clock\0timeChanged\0\0updateTime\0currentTime\0"
    "today_date\0currentTime_short"
};
...
void Clock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< QString*>(_v) = _t->today_date(); break;
        case 2: *reinterpret_cast< QString*>(_v) = _t->currentTime_short(); break;
        default: break;
        }
