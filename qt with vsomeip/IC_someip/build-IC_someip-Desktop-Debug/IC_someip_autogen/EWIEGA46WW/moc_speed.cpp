...
QT_MOC_LITERAL(1, 6, 12), // "speedChanged"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 8), // "newSpeed"
QT_MOC_LITERAL(4, 29, 11), // "updateSpeed"
QT_MOC_LITERAL(5, 41, 5) // "speed"

    },
    "Speed\0speedChanged\0\0newSpeed\0updateSpeed\0"
    "speed"
};
...
void Speed::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Speed::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Speed::speedChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Speed::speedChanged(int _t1)
{
