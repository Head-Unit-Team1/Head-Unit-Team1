...
ShanWanGamepadInput ShanWanGamepad::read_data()
{
	...
	// Buttons
        ...
        if (gamepad_input.button_a == 243){
            gamepad_input.button_a = -1;
        }else{
            gamepad_input.button_a = 243;
        }
	} else if (button_number == 1) {
        gamepad_input.button_b = 243;
	} else if (button_number == 2) {
		// Do nothing (pass)
	} else if (button_number == 3) {
        gamepad_input.button_x = 243;
	} else if (button_number == 4) {
        gamepad_input.button_y = 243;
	} else if (button_number == 5) {
		// Do nothing (pass)
	} else if (button_number == 6) {
        gamepad_input.button_l1 = 243;
	} else if (button_number == 7) {
        gamepad_input.button_r1 = 243;
        ...
        gamepad_input.button_select = 243;
